            ...
            <div className='flex flex-col mt-20 md:flex-row items-center justify-around'>
              ...
              <div className='w-full md:w-[40%]'>
                <div className="w-full">
                  ...
                  <p className="text-base p-1 mt-4 pl-1">Não perca a oportunidade de alcançar a melhor versão de si mesmo. Garanta sua consulta com um dos mais conceituados cirurgiões plásticos de Brasília!</p>
                </div>
              </div>
            </div>
          </div>
